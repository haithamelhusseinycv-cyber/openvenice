    ...
    build: () => {
      ...
      return {
        nodes: [
          ...
          { id: b, type: 'venice', position: { x: 280, y: 220 }, data: { label: 'LLM', nodeType: 'chat', model: 'qwen-3-6-plus', prompt: 'You are an art director. Given this album concept, write a vivid, specific image-generation prompt for the cover art — mood, color palette, composition, subject, style. Output only the prompt.', temperature: 0.9 } },
    ...
    build: () => {
      ...
      return {
        nodes: [
          ...
          { id: b, type: 'venice', position: { x: 280, y: 220 }, data: { label: 'LLM', nodeType: 'chat', model: 'qwen-3-6-plus', prompt: 'Research this topic. Provide specific facts, mechanisms, and current developments. Cite sources.', webSearch: 'off', temperature: 0.5 } },
          { id: c, type: 'venice', position: { x: 280, y: 460 }, data: { label: 'LLM', nodeType: 'chat', model: 'qwen-3-6-plus', prompt: 'Rewrite this research as a conversational ~90-second podcast monologue. Start with a hook. No headings, no bullet points — just flowing spoken English.', temperature: 0.7 } },
    ...
    build: () => {
      ...
      return {
        nodes: [
          ...
          { id: b, type: 'venice', position: { x: 340, y: 220 }, data: { label: 'LLM', nodeType: 'chat', model: 'qwen-3-6-plus', prompt: 'You are a music-video director. Expand this mood into a single paragraph that captures visual style, camera, and sonic atmosphere. One tight paragraph, no lists.', temperature: 0.9 } },
    ...
    build: () => {
      ...
      return {
        nodes: [
          ...
          { id: b, type: 'venice', position: { x: 280, y: 220 }, data: { label: 'LLM', nodeType: 'chat', model: 'qwen-3-6-plus', prompt: 'Write a short song (verse, chorus, verse) about this theme. Keep it under 100 words. Output only the lyrics — no headers or commentary.', temperature: 0.9 } },
    ...
    build: () => {
      ...
      return {
        nodes: [
          ...
          { id: b, type: 'venice', position: { x: 280, y: 220 }, data: { label: 'LLM', nodeType: 'chat', model: 'qwen-3-6-plus', prompt: 'Expand this premise into a single cinematic scene description: setting, time of day, weather, key visual detail, subject pose, mood. 3-4 sentences, no narrative — purely visual.', temperature: 0.9 } },
