...
# NOTE: biometric gating uses the PLATFORM android.hardware.biometrics APIs —
# no androidx.biometric dependency. Bundled biometric libraries age badly
# across Android releases; the framework version matches the device exactly.
